export default class Text {
     ...
     */
    static getLevenshteinDistance(stringA = '', stringB = '') {
        const track = Array(stringB.length + 1).fill(null).map(() => Array(stringA.length + 1).fill(null));
        ...
        return track[stringB.length][stringA.length];
    };
